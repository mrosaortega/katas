...
resultado = frecuencias_letras("hola mundo")
print(resultado)

"""2. Dada una lista de números, obtén una nueva lista con el doble de cada valor. Usa la función map() """

lista_numeros = [1, 2, 20, 54, 67, 222]
def lista_numeros_dobles(numero):
    return (numero * 2)
...
print(buscar_palabras(lista_palabras, "c"))

""" 4. Genera una función que calcule la diferencia entre los valores de dos listas. Usa la función map()"""

lista_1 = [1, 2, 20, 54, 67, 222]
lista_2= [2, 4, 40, 108, 134, 444]


def resta_listas(lista_1, lista_2):
    return list(map(lambda x, y: x - y, lista_1, lista_2))

resultado = resta_listas(lista_1, lista_2)
print(resultado)
...
resultado = nota_final(lista_notas, 5)
print(resultado)
...
def filtrar_mascotas(mascota):
    return mascota.lower() not in [m.lower() for m in lista_mascotas_prohibidas]
...
def sumar ():
    return map(lambda numero: numero +3, lista)
...
producto_total = reduce(lambda x,y: x*y, lista_digitos)
